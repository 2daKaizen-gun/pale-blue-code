 ...
 *   [Light 4] ★현재★ — 시각적 셸 + 강조 분기. 클릭은 placeholder
 ...
 *   현재 레이아웃은 *시간 컨트롤만* 으로 좁게 디자인 — sub-2-4 에서 가로 확장 또는
 *   2단 배치 검토. 모바일에선 *두 줄* 로 갈 가능성.
 *
 * ─── 디자인 토큰 ───────────────────────────────────
 *   Phase 1 토큰 (`var(--color-cosmos-bg)` 등) 정식 적용은 sub-2-6 UI 마무리.
 *   현재는 *공통 다크 우주 테마* 로 빠르게: bg-black/40 + backdrop-blur.
 */

/**
 * 속도 표기: 1×, 100×, 10,000×, 100,000×.
 * toLocaleString 으로 천 단위 콤마 — 정확함 우선 (10K× 같은 단축형 X).
 */
